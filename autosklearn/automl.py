...
class AutoML(BaseEstimator):
    ...
    def cv_results_(self):
        ...
        for run_key in self.runhistory_.data:
            ...
            elapsed_time = run_value.additional_info['elapsed_time'] if 'elapsed_time' in run_value.additional_info else None            
            elapsed_times.append(elapsed_time)
            
            config_id = run_key.config_id
            config_ids.append(run_value.additional_info['num_run'] if 'num_run' in run_value.additional_info else None)
